...
class FilterUtils:
    ...
    def add_filter(self, ftype: int, first_param: str, second_param: str = None) -> None:
...
async def filter_controller(client: Client, msg: types.Message, is_edit: bool = False) -> None:
...
async def filter_interact(client, msg: types.Message) -> None:
    # Filter type
    data = msg.data.split(" ")
    ...
    if data[1] == "add":
        ...
        if data[2] == "replace":
            ...
            if valg is None:
                ...
                if "|" not in valg:
                    ...
                    fsu.add_filter(FilterUtils.REPLACE_FILTER, valg[0], valg[1])
            ...
            if len(data) == 4:
                ...
                if valg is None:
                    ...
                    if data[3] == "left":
                        ...
                        fsu.add_filter(FilterUtils.ADDITION_FILTER, valg, FilterUtils.ADDITION_FILTER_LEFT)
                        await msg.message.edit_text(fltr_add + success_add, reply_markup=markup1)
                    else:
                        success_add = "\n" + Trans.ADDITION_FILTER_SUCCESS_RIGHT.format(valg)
                        fsu.add_filter(FilterUtils.ADDITION_FILTER, valg, FilterUtils.ADDITION_FILTER_RIGHT)
                        await msg.message.edit_text(fltr_add + success_add, reply_markup=markup1)
            else:
        ...
        if data[2] == "remove":
            ...
            if valg is None:
                ...
                fsu.add_filter(FilterUtils.REMOVE_FILTER, valg)
                await msg.message.edit_text(fltr_add + success_add, reply_markup=markup1)
